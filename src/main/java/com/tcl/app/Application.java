...
@Configuration
@ComponentScan(basePackages= "com.tcl")
@EnableAutoConfiguration
@EntityScan(basePackages="com.tcl.pojo")
@EnableJpaRepositories(basePackages= "com.tcl.repository")
@EnableConfigurationProperties(Audiences.class)
@SpringBootApplication
@EnableScheduling
@MapperScan("com.tcl.dao")
